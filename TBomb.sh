...
echo -e "\e[1;32m           Mail: ggmsnofficial.assist@gmail.com \e[0m"
echo -e "\e[4;32m   Contact Us: http://bit.ly/contact_msn \e[0m"
echo " "
...
if [[ -s sms-bomber/sms-bomber.sh ]];then
cd sms-bomber
cp -r -f * .. > temp
cd ..
rm -rf  sms-bomber >> temp
rm update.Manoj Nehete >> temp
rm temp
chmod +x sms-bomber.sh
fi
echo -e "\e[1;32m sms-bomber Will Restart Now..."
...
echo "         [-] Mail At: ggmsnofficial.assist@gmail.com"
...
echo -e "\e[1;34m For Any Queries Mail Me!!!\e[0m"
echo -e "\e[1;32m           Mail: ggmsnofficial.assist@gmail.com \e[0m"
echo -e "\e[1;32m       Whatsapp: https://bit.do/Manoj Nehetegit \e[0m"
echo -e "\e[4;32m   Contact Us: http://bit.ly/contact_msn \e[0m"
...
echo -e "\e[1;32m       Whatsapp: https://bit.do/Manoj Nehete \e[0m"
echo -e "\e[4;32m   Contact Us: http://bit.ly/contact_msn \e[0m"
echo " "
exit 0
else
